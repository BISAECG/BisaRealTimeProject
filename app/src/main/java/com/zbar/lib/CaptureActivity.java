...
//							getResources().getString(R.string.msg_camera_framework_bug));
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_camera_scan_qr_code);
		...
		//mImgTopMask = findViewById(R.id.top_mask);
		...
		mErrorNoCamera = findViewById(R.id.tv_camera_scan_qrcode_capture_error_nocamera);
		
		mResultView = findViewById(R.id.llayout_camera_scan_qrcode_result_view);

		mBtnConfirm = findViewById(R.id.btn_camera_scan_qrcode_confirm);
		mBtnConfirm.setOnClickListener(this);

		mBtnRetry = findViewById(R.id.btn_camera_scan_qrcode_retry);
		mBtnRetry.setOnClickListener(this);

		mTvDeviceSn = findViewById(R.id.tv_camera_scan_qrcode_sn);
	...
	private void startScan() {
		...
		CameraManager.init(getApplication());
		inactivityTimer = new InactivityTimer(this);
		SurfaceView surfaceView = findViewById(R.id.surfaceView_camera_scan_qrcode_preview);
