...
public class CustomUploadProgressDialog extends Dialog {
    ...
    public CustomUploadProgressDialog(@NonNull Context context) {
        super(context);
    }

    public CustomUploadProgressDialog(@NonNull Context context, @StyleRes int themeResId) {
        super(context, themeResId);

    }

    protected CustomUploadProgressDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    public static class Builder {
        ...
        public CustomUploadProgressDialog create(){

            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final CustomUploadProgressDialog dialog = new CustomUploadProgressDialog(context,R.style.Dialog);
            View view = inflater.inflate(R.layout.dialog_otg_load_upload, null);
            //加载布局
