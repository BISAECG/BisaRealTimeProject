...
public class CustomPackageProgressDialog extends Dialog {




    public CustomPackageProgressDialog(@NonNull Context context) {
        super(context);
    }

    public CustomPackageProgressDialog(@NonNull Context context, @StyleRes int themeResId) {
        super(context, themeResId);

    }

    protected CustomPackageProgressDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    public static class Builder {
        ...
        public CustomPackageProgressDialog create(){

            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final CustomPackageProgressDialog dialog = new CustomPackageProgressDialog(context,R.style.Dialog);
            View view = inflater.inflate(R.layout.dialog_otg_load_copy, null);
            //加载布局
