...
import com.bisa.health.ecg.ECGSetAcitvity;
 ...
 */
public class ActionBarBackSetingFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_action_setting_bar, container, false);
    ...
    public void onClick(View v) {
        ...
        }else if(v==ibtn_setting){
            ActivityUtil.startActivity(getActivity(), ECGSetAcitvity.class, false, ActionEnum.NEXT);
        }
    }
