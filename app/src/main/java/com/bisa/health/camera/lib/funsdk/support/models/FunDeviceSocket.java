package com.bisa.health.camera.lib.funsdk.support.models;


import com.bisa.health.camera.lib.funsdk.support.config.BaseConfig;
import com.bisa.health.camera.lib.funsdk.support.config.OPPowerSocketGet;
import com.bisa.health.camera.lib.funsdk.support.config.PowerSocketArm;
import com.bisa.health.camera.lib.funsdk.support.config.PowerSocketAutoLight;
import com.bisa.health.camera.lib.funsdk.support.config.PowerSocketAutoSwitch;
import com.bisa.health.camera.lib.funsdk.support.config.PowerSocketAutoUsb;
import com.bisa.health.camera.lib.funsdk.support.config.PowerSocketBanLed;
import com.bisa.health.camera.lib.funsdk.support.config.PowerSocketDelayLight;
import com.bisa.health.camera.lib.funsdk.support.config.PowerSocketDelaySwitch;
import com.bisa.health.camera.lib.funsdk.support.config.PowerSocketDelayUsbPower;
import com.bisa.health.camera.lib.funsdk.support.config.PowerSocketImage;
import com.bisa.health.camera.lib.funsdk.support.config.PowerSocketSensitive;
import com.bisa.health.camera.lib.funsdk.support.config.PowerSocketWorkRecord;
